...
public:
  ...
  /// Used to detect backing type during setup and to remove an empty
  /// generation. In the latter case bool value says if to remove (false)
  /// or only clear(true) the object
  ///
